...
export default function Dashboard() {
  ...
  if (!mounted)
    return (
      <div className="p-10 text-center text-gray-400">Loading FinBoard...</div>
    );
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto mb-8 flex justify-between items-center">
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg font-medium shadow-sm transition-all"
        >
          + Add Widget
        </button>
      </div>
